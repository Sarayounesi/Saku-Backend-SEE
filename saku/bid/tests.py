...
class BidTest(TestCase):
    ...
    def test_create_bid_failure_auction_owner(self):
        ...
        self.assertIn(
            ErrorDetail(
                string="Auction owners cannot bids for their auctions.", code="invalid"
            ),
    ...
    def test_create_bid_failure_finished_auction(self):
        ...
        self.assertIn(
            ErrorDetail(
                string="Users cannot bid for finished auctions.", code="invalid"
            ),
            response.data["non_field_errors"],
        )
    ...
    def test_create_bid_failure_limit_1(self):
        ...
        self.assertIn(
            ErrorDetail(
                string="Users cannot bid lower than auction limit.", code="invalid"
            ),
            response.data["non_field_errors"],
        )
    ...
    def test_create_bid_failure_higher_exists(self):
        ...
        self.assertIn(
            ErrorDetail(
                string="Higher bid for this auction already exists.", code="invalid"
            ),
            response.data["non_field_errors"],
        )
