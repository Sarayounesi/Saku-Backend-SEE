...
class HomePageTest(TestCase):
    def setUp(self):
        ...
        self.user1 = User.objects.create_user(
            username="test_user1", password="Ab654321"
        )
        ...
        self.user2 = User.objects.create_user(
            username="test_user2", password="Ab654321"
        )
        ...
        tags = [tag1, tag2]
        self.auction1_user1 = Auction.objects.create(
            created_at="2019-05-24T14:15:22Z",
            token="Aap5qjB1",
            name="string",
        ...
        self.auction2_user1 = Auction.objects.create(
            created_at="2020-06-24T14:15:22Z",
            token="Bap5qjB2",
            name="string",
        ...
        self.auction3_user2 = Auction.objects.create(
        ...
        self.auction4_user2 = Auction.objects.create(
        ...
        # create bids
        self.bid1_user2 = Bid.objects.create(
            user=self.user2,
            price=500,
            auction=self.auction1_user1,
            time="2020-07-24T14:15:22Z",
        )
        self.auction1_user1.participants_num = 1
        self.auction1_user1.best_bid = self.bid1_user2
        self.auction1_user1.save()

        self.bid2_user2 = Bid.objects.create(
            user=self.user2,
            price=400,
            auction=self.auction2_user1,
            time="2020-07-24T14:15:22Z",
        )
        self.auction2_user1.participants_num = 1
        self.auction2_user1.save()

        self.bid3_user1 = Bid.objects.create(
            user=self.user1,
            price=300,
            auction=self.auction3_user2,
            time="2020-07-24T14:15:22Z",
        )
        ...
        self.bid4_user1 = Bid.objects.create(
            user=self.user1,
            price=200,
            auction=self.auction4_user2,
            time="2020-07-24T14:15:22Z",
        )
